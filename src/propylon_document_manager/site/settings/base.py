...
# ------------------------------------------------------------------------------
# Upload directory for file versions (relative to MEDIA_ROOT)
FILE_UPLOAD_DIR = env.str("DJANGO_FILE_UPLOAD_DIR", default="uploads/")
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "propylon_document_manager.utils.custom_exception_handler",
}
